      ...
      <section style={{padding: 'clamp(80px, 12vw, 140px) 0', borderTop: '1px solid var(--line)'}}>
        <div className="container">
          ...
          <div className="reveal fleet-photo-grid">
            <img src="images/fleet3.jpg" alt="車両 3" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} />
            <img src="images/fleet1.jpg" alt="車両 1" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} />
            <img src="images/fleet2.jpg" alt="車両 2" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} />
          </div>
