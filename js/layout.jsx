    ...
    <>
      <header className={`site-header ${scrolled ? 'is-scrolled' : ''} ${overDark && !scrolled ? 'over-dark' : ''}`}>
        <a href="#/" className="logo">
          <img src="images/logo.png" alt="マルタチ" style={{height: 36, display: 'block'}} />
        </a>
        <nav className="nav">
          {PAGES.map(p => (
    ...
    <footer className="site-footer" style={{padding: '40px var(--gutter)', textAlign: 'center'}}>
      <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 24, flexWrap: 'wrap', marginBottom: 16}}>
        ...
        <div style={{textAlign: 'center'}}>
          <p style={{fontFamily: 'var(--font-jp-body)', fontSize: 11, letterSpacing: '0.06em', color: 'var(--paper)', margin: '0 0 4px'}}>
            〒349-0135 埼玉県蓮田市井沼843-1
          </p>
          <a href="tel:0488848106" style={{fontFamily: 'var(--font-mono)', fontSize: 13, letterSpacing: '0.12em', color: 'var(--paper)', fontWeight: 500, textDecoration: 'none', display: 'block'}}>
            <span style={{fontSize: 11, fontWeight: 400}}>TEL. </span>048-884-8106
          </a>
        </div>
      </div>
